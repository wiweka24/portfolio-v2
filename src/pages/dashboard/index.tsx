...
const S = Math.round(Math.min((window.innerHeight - 92) * 0.4, window.innerWidth * 0.3));
...
export default function Dashboard() {
  ...
  return (
    <div className="relative flex h-screen w-screen overflow-hidden bg-white dark:bg-black dark:text-white select-none transition-colors duration-300">
      {/* ── Frame border ── */}
      <div className="absolute top-0 h-4 w-screen bg-black dark:bg-white z-30" />
      <div className="absolute bottom-0 h-4 w-screen bg-black dark:bg-white z-30" />
      <div className="absolute left-0 h-screen w-4 bg-black dark:bg-white z-30" />
      <div className="absolute right-0 h-screen w-4 bg-black dark:bg-white z-30" />
      <div className="absolute top-4 left-4 h-4 w-4 bg-black dark:bg-white z-30" />
      <div className="absolute top-4 left-4 h-4 w-4 rounded-tl-full bg-white dark:bg-black z-30" />
      <div className="absolute top-4 right-4 h-4 w-4 bg-black dark:bg-white z-30" />
      <div className="absolute top-4 right-4 h-4 w-4 rounded-tr-full bg-white dark:bg-black z-30" />
      <div className="absolute bottom-4 left-4 h-4 w-4 bg-black dark:bg-white z-30" />
      <div className="absolute bottom-4 left-4 h-4 w-4 rounded-bl-full bg-white dark:bg-black z-30" />
      <div className="absolute right-4 bottom-4 h-4 w-4 bg-black dark:bg-white z-30" />
      <div className="absolute right-4 bottom-4 h-4 w-4 rounded-br-full bg-white dark:bg-black z-30" />
      ...
      <div
        ref={setRef("vtext")}
        className="absolute left-16 bottom-30 z-10 pointer-events-none origin-bottom-left -rotate-90"
      >
      ...
      {/* ══════════════════════════════════════
          TOP-LEFT
      ══════════════════════════════════════ */}
      <div ref={setRef("topleft")} className="absolute top-8 left-10 z-10">
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-shrink-0">
              ...
              <img
                src={pp_silvia}
                alt="avatar"
                className="w-16 h-16 rounded-full border-[3px] border-white object-cover object-top"
              />
            </div>
            <span className="font-black text-xl">wiweka24</span>
            <Cat className="w-5 h-5 flex-shrink-0" strokeWidth={2.5} />
          </div>

          <div className="flex flex-col gap-1 min-w-[220px] mt-4">
            <p className="font-black text-xs tracking-widest">{lang === "en" ? "LEVEL" : "レベル"}</p>
            <div className="flex items-center gap-2">
              <span className="font-black text-4xl leading-none w-10">24</span>
              <div className="relative flex-1 h-8 rounded-full overflow-hidden bg-gray-100 dark:bg-gray-800 border-2 border-black dark:border-white">
                <div className="absolute inset-0 rounded-full bg-black dark:bg-white" style={{ width: "24%" }} />
                <span className="absolute inset-0 flex items-center justify-center text-white font-black text-xs mix-blend-difference">
                  24 / 100
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 mt-2">
              <a 
                ...
                className="w-10 h-10 rounded-lg flex items-center justify-center border-2 border-black dark:border-white bg-white dark:bg-black text-black dark:text-white hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all shadow-[2px_2px_0_#000] dark:shadow-[2px_2px_0_#fff] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none cursor-pointer"
                title="GitHub"
              >
      ...
      {/* ══════════════════════════════════════
          TOP-RIGHT
      ══════════════════════════════════════ */}
      <div ref={setRef("topright")} className="absolute top-8 right-8 flex items-start gap-4 z-10">
        <div className="flex flex-col gap-2">
          <Button className="-rotate-2 w-20 h-20 px-0 py-0 rounded-xl hover:scale-105 active:scale-95 transition-all" onClick={() => setShowCV(!showCV)}>
            <FileText className="size-6" />
            <span className="font-black text-xs">{lang === "en" ? "CV" : "履歴書"}</span>
          </Button>
          <Button className="rotate-1 w-20 h-20 px-0 py-0 rounded-xl hover:scale-105 active:scale-95 transition-all" onClick={() => setLang(l => l === "en" ? "jp" : "en")}>
            <Globe className="size-6" />
            <span className="font-black text-xs">{lang === "en" ? "日本語" : "English"}</span>
          </Button>
          <Button className="-rotate-1 w-20 h-20 px-0 py-0 rounded-xl hover:scale-105 active:scale-95 transition-all" onClick={() => setDark(d => !d)}>
            {dark ? <Sun className="size-6" /> : <Moon className="size-6" />}
            <span className="font-black text-xs">{dark ? (lang === "en" ? "Light" : "ライト") : (lang === "en" ? "Dark" : "ダーク")}</span>
          </Button>
        </div>
      </div>
      ...
      ══════════════════════════════════════ */}
      {showCV && (
        <div ref={setRef("cv")} className="absolute inset-0 flex items-center justify-center z-40 p-10 pointer-events-none">
          <div className="relative w-full max-w-4xl h-[85vh] pointer-events-auto">
            <div className="relative w-full h-full bg-white dark:bg-black border-4 border-black dark:border-white rounded-3xl p-2 shadow-[8px_8px_0_#000] dark:shadow-[8px_8px_0_#fff]">
              
              {/* Header pill */}
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 whitespace-nowrap z-50">
                <span className="font-black px-8 py-2 rounded-full text-lg border-4 border-black dark:border-white bg-black dark:bg-white text-white dark:text-black flex items-center gap-2">
      ...
      {/* ══════════════════════════════════════
          Speech bubble
      ══════════════════════════════════════ */}
      <div ref={setRef("bubble")} className="absolute z-10 cursor-pointer" style={{ top: "22%", right: "25%" }} onClick={nextQuote}>
      ...
      ══════════════════════════════════════ */}
      <div className="absolute bottom-32 right-10 flex flex-col items-end gap-10 z-10">
        ...
        <div ref={setRef("botleft")} className="relative">
          <div style={{ transform: "rotate(-2deg)" }}>
            {/* Outer card */}
            <div
              className="relative rounded-2xl border-2 border-black dark:border-white bg-white dark:bg-black p-2 w-[280px]"
              style={{ boxShadow: dark ? "3px 3px 0 #fff" : "3px 3px 0 #000" }}
            >
              {/* Quest pill overlapping top border */}
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 whitespace-nowrap">
                <span
                  className="font-black px-5 py-1 rounded-full text-sm border-2 border-black dark:border-white bg-black dark:bg-white text-white dark:text-black"
                >
                  {lang === "en" ? "Quest" : "クエスト"}
                </span>
              </div>
              ...
              {/* Inner frame */}
              <div className="rounded-xl border-2 border-black dark:border-white px-4 py-4 mt-2 flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg flex-shrink-0 flex items-center justify-center border-2 border-black dark:border-white bg-gray-100 dark:bg-gray-800">
                    <span className="font-black text-xl text-black dark:text-white">あ</span>
                  </div>
                  <div className="flex flex-col">
                    <p className="font-bold leading-tight text-sm">
                      {lang === "en" ? "Learning Japanese" : "日本語を勉強中"}
                    </p>
                    <p className="font-black text-xs opacity-60">
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between items-end px-1">
                    <span className="font-black text-[10px] uppercase tracking-tighter opacity-50">
                      {lang === "en" ? "Next Boss" : "次のボス"}
                    </span>
                    <div className="flex items-baseline gap-1">
                      <span className="font-black text-xs">20%</span>
                      <span className="font-black text-[10px] uppercase tracking-tighter opacity-50">/</span>
                      <span className="font-black text-[10px] uppercase tracking-tighter">N4</span>
                    </div>
                  </div>
                  <div className="relative h-2 w-full bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden border border-black/10 dark:border-white/10">
        ...
        <div ref={setRef("music")} className="relative">
          <div style={{ transform: "rotate(-2deg)" }}>
            ...
            >
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 whitespace-nowrap">
                <span className="font-black px-5 py-1 rounded-full text-sm border-2 border-black dark:border-white bg-black dark:bg-white text-white dark:text-black">
                  {lang === "en" ? "Now Playing" : "再生中"}
                </span>
              </div>
              <div className="rounded-xl border-2 border-black dark:border-white px-4 py-3 mt-2 flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="flex flex-col flex-1 min-w-0">
                    <p className="font-black text-sm leading-tight truncate">{SONGS[currentSongIndex].title}</p>
                    <p className="font-bold text-xs opacity-60 truncate">{SONGS[currentSongIndex].artist}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-2">
                  <button
                    ...
                    className="w-10 h-10 rounded-lg flex items-center justify-center border-2 border-black dark:border-white bg-black dark:bg-white text-white dark:text-black active:scale-90 transition-all disabled:opacity-50 cursor-pointer"
                  >
                  ...
                  <button
                    onClick={togglePlay}
                    disabled={!isPlayerReady}
                    className={`w-10 h-10 rounded-lg flex items-center justify-center border-2 border-black dark:border-white bg-black dark:bg-white text-white dark:text-black active:scale-90 transition-all ${!isPlayerReady ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}
                  >
